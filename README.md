...
python3 tools/walkthrough/build.py ../qlab-plugin-ldap-lab        # English
python3 tools/walkthrough/build.py ../qlab-plugin-ldap-lab -it    # Italian
python3 tools/walkthrough/build.py ../qlab-plugin-ldap-lab --live # re-capture first
```
